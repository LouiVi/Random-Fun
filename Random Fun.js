...
var fonts = ["Misc/SourGummy_Expanded-Medium.ttf","Misc/Bokor-Regular.ttf","Misc/Poppins-MediumItalic.ttf","Misc/EduAUVICWANTPre-Regular.ttf"];//Misc/Danfo-Regular-VariableFont_ELSH.ttf","Misc/Audiowide-Regular.ttf","Misc/Crushed-Regular.ttf","Misc/DancingScript-VariableFont_wght.ttf","Misc/Jersey10Charted-Regular.ttf","Misc/LuckiestGuy-Regular.ttf","Misc/MontserratAlternates-ExtraLight.ttf"];
...
CreateMenuBar(rColor);
	...
	txt = app.CreateText( "", 1, 0.8, "Multiline,VCenter" )
	txt.SetTextSize( 32, "dip")
	txt.SetTextShadow( 7, 0, 0, "#000000" );
	lay.AddChild( txt )
